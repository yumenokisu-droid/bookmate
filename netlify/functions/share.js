...
export async function handler(event) {
  ...
  return { statusCode: 200, headers: { "Content-Type": "text/html; charset=utf-8" }, body: sharePageHTML(item) };
}
